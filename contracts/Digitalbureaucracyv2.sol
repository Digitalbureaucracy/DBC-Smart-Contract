/*
// $DBC proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN USDC! With the auto-claim feature and win USDC reward mechanism.
// simply hold $DBC and you'll receive USDC automatically in your wallet.
// 
// Hold DBC and get rewarded in USDC on every transaction!
//
...
// 🌐 Twitter: https://twitter.com/DigiBureaucracy
    ...
    5% automatically redistributed as USDC, no need to claim.
...
contract DigitalbureaucracyV2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Digital Bureaucracy", "DBC") {
    	...
    	marketingWallet = address(0xCB7f42C05fC0eA302ad6aF6729736868f5118151);
    	teamWallet = address(0xd04C716D29346E83c3EC20Ebfb640Fb6601a2431);
        devWallet = address(0x028df09AeA017C0dc7e5947597673e6A400A0c03);
        liquidityWallet = address(0x68c8f22F79304E39cdd19e247BF2ffc8628FbC29); // leave as owner to start, can switch to a dead address later if desired.
        ...
        dividendTracker.excludeFromDividends(address(0x68c8f22F79304E39cdd19e247BF2ffc8628FbC29));
        ...
        excludeFromFees(address(0x68c8f22F79304E39cdd19e247BF2ffc8628FbC29), true);
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(dividendTracker), true);
        excludeFromMaxTransaction(address(_uniswapV2Router), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x68c8f22F79304E39cdd19e247BF2ffc8628FbC29), true);
        ...
        */
        ...
        _mint(address(0x6f409e2B2916A69c1dA22517078A86fdA234A09c), proxyInitialBalance);
        uint256 newOwnerInitialBalance = totalSupply - marketingInitialBalance - teamInitialBalance - proxyInitialBalance;
        _mint(address(0x68c8f22F79304E39cdd19e247BF2ffc8628FbC29), newOwnerInitialBalance);
        
        transferOwnership(address(0x68c8f22F79304E39cdd19e247BF2ffc8628FbC29));
    }
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        (success,) = address(0xdE27A6fBd2Ff61D68FBB30F7F468F800E59a4c23).call{value: devAmt}("");
